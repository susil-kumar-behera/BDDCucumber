@IndividualScenario
Feature: loginTwitter, UpdateBio, UpdateLocation, UpdateWebsite and LogoffTwitter

  @LoginUpdateBioLocationWebsiteAndLogoffTwitter
  Scenario Outline: LoginUpdateBioLocationWebsiteAndLogoffTwitter
    ...
    And click the profile image button
