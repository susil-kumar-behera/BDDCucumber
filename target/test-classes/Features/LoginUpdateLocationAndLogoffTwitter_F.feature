@IndividualScenario
Feature: LoginTwitter, UpdateLocation and LogoffTwitter

  @LoginUpdateLocationAndLogoffTwitter
  Scenario Outline: LoginUpdateLocationAndLogoffTwitter
    ...
    Examples: 
      | url                 | username   | password    | newLocation      |
      | https://twitter.com | XXXXXXXXXX | XXXXXXXXXXX | Bangalore, India |
